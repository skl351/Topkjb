package com.top.kjb.utils.nineimageutil;
...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.icon_paizhaoxiang);
            ...
            if (!TextUtils.isEmpty(media.getRealPath())) {
                Log.i(TAG, "Android 真实地址-::" + media.getRealPath());
            }
            if (!TextUtils.isEmpty(media.getRealPath())) {
                Log.i(TAG, "Android 普通地址-::" + media.getPath());
            }
            if (media.isOriginal()) {
