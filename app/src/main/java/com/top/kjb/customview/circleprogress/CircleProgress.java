package com.top.kjb.customview.circleprogress;
...
import com.top.kjb.customview.circleprogress.utils.Constant;
import com.top.kjb.customview.circleprogress.utils.MiscUtil;
...
//        canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset, mValuePaint);
        ...
        if (mHint != null) {
            canvas.drawText(mHint.toString(), mCenterPoint.x, mValueOffset, mHintPaint);
        }
...
//        mArcPaint.setShader(mSweepGradient);
        mArcPaint.setColor(mContext.getColor(R.color.color_1cbe6f));
    }
