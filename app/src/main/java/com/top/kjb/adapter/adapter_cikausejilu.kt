 ...
 */
class adapter_cikausejilu : RecyclerView.Adapter<RecyclerView.ViewHolder> {
    var mInflater: LayoutInflater? = null
    var mData: ArrayList<bean_cikausejilu>? = null
    ...
    constructor(context: Context, list: ArrayList<bean_cikausejilu>) : super() {
        mData = list
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        val view = mInflater?.inflate(R.layout.layout_cika_usejilu, p0, false)
