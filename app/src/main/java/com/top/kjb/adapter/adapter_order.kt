 ...
 */
class adapter_order : RecyclerView.Adapter<RecyclerView.ViewHolder> {
    var mInflater: LayoutInflater? = null
    var mData: ArrayList<bean_order_item>? = null
    ...
    constructor(context: Context, list: ArrayList<bean_order_item>) : super() {
        mData = list
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): androidx.recyclerview.widget.RecyclerView.ViewHolder {
        val view = mInflater?.inflate(R.layout.layout_order_item_view, p0, false)
