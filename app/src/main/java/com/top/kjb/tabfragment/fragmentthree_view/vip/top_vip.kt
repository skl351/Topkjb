package com.top.kjb.tabfragment.fragmentthree_view.vip
...
import com.top.kjb.tabfragment.fragmentthree_view.orderlist.order1_list
import com.top.kjb.utils.functionClass
import kotlinx.android.synthetic.main.layout_top_vip.*


class top_vip : BaseActivity(),View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.layout_top_vip)
        init_viewpage()
    }
    ...
    private fun init_adapter() {
        var width_use= functionClass.getScreenWidth(this)/2
        var huizhen=20
