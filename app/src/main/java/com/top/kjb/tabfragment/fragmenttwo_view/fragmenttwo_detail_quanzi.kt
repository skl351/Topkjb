...
class fragmenttwo_detail_quanzi : BaseActivity(), View.OnClickListener {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            when (intent.action) {
                Sp.huifuintent -> {
                    ...
                    id_edit.setText("")
                    id_edit.setHint("回复")
                    java_util().showInput(id_edit, this@fragmenttwo_detail_quanzi)
                }
    ...
    private fun init_huifu() {
        ...
        twoModel.circleReplyinsertCircleReply(
            ...
            .enqueue(object : retrofit2.Callback<Result<String>> {
                ...
                override fun onResponse(
                    ...
                    if ("success".equals(bean?.flag)) {
                        Show_toast.showText(this@fragmenttwo_detail_quanzi, bean?.result)
                        init_list(id)
                        java_util().hideInput(this@fragmenttwo_detail_quanzi)
                    } else {
                        Show_toast.showText(this@fragmenttwo_detail_quanzi, "炫亮点评论list失败")
                    }
    ...
    private fun init_send() {
        var text = id_edit.text.toString()
        twoModel.circleCommentsinsertCircleComments(
            functionClass.getToken(),
            ...
            .enqueue(object : retrofit2.Callback<Result<String>> {
                ...
                override fun onResponse(
                    ...
                    if ("success".equals(bean?.flag)) {
                        ...
                        Show_toast.showText(this@fragmenttwo_detail_quanzi, "圈子评论list失败")
                    }
    ...
    private fun init_quanzi() {
        id_big_view.visibility = View.GONE
        twoModel.circleselectCircleById(
                ...
                if ("success".equals(bean?.flag)) {
                    ...
                    if ("".equals(pic)) {
                        ...
                        adapter_nine = adapter_nine_image(
                            this@fragmenttwo_detail_quanzi,
                            piclist
                        )
                    ...
                    Show_toast.showText(this@fragmenttwo_detail_quanzi, "获取炫亮点详情")
                }
    ...
    private fun init_list(id: Int) {
        ...
        twoModel.circleCommentsselectComments(
            functionClass.getToken(),
            id,
            currentpage,
            pagesize
            ...
            .enqueue(object : retrofit2.Callback<Result<bean_user_comment>> {
                ...
                override fun onResponse(
                    ...
                    if ("success".equals(bean?.flag)) {
                        ...
                        adapter_comment =
                            adapter_user_comment2(this@fragmenttwo_detail_quanzi, list)
                        adapter_comment.textType=1
        ...
        twoModel.circleLikesinsertCircleLikes(
            ...
            override fun onResponse(call: Call<Result<Int>>, response: Response<Result<Int>>) {
                ...
                if ("success".equals(bean?.flag)) {
                    ...
                    Show_toast.showText(this@fragmenttwo_detail_quanzi, "操作失败")
                }
                id_like_image_big.isEnabled = true
            }
